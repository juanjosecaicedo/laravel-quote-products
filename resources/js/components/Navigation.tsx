import {BaggageClaim, ChartCandlestick, LogOut, User} from "lucide-react";
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="md:hidden">
            <button type="button"
              ...
              <svg className="hs-collapse-open:hidden size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
